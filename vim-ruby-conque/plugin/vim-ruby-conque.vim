...
function! RunSingleConque(command)
  ...
  endtry
  let g:single_conque = conque_term#open(a:command, ['botright split', 'res 15'])
endfunction

function! RunSpecAllFilesConque()
  call RunSingleConque("rspec --color")
endfunction
...
function! RunBashConque()
  call RunSingleConque("bash")
endfunction
...
function! CloseConque()
  call g:single_conque.write(':q')
endfunction
